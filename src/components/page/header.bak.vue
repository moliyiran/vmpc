    ...
    <div id="header">
        <header>
            <div class="stripe white-stripe">
                ...
                <img  src="https://static-l3.xvideos-cdn.com/v3/img/skins/default/xvideos.com.png" title="XVideos 主頁" height="36" width="144" class="no-blur" id="site-logo"    @click="handleinput(1)"/>
