<template>
        <div>
        <div id="nav" class="nav-elem nav-elem opened">
            <nav aria-label="primary">
                <div class="main-categories ordered-label-list">
                    <ul>
                        <!--
                        <li><router-link class="btn btn-default label red-label" :to="'/history'">最佳影片</router-link> </li>
                        -->
                        <li><router-link class="btn btn-default label red-label history-label" :to="'/history'">观看历史</router-link> </li>
                        <li><router-link class="btn btn-default label red-label" :to="'/stars'">色情明星</router-link> </li>
